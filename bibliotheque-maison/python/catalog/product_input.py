"""Helpers pour normaliser les lignes d'entrée produit."""
...
@dataclass
class ProductInput:
    """Conteneur simple pour les lignes produit."""
    code_barre: str | None
    libelle: str
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Retourne un dictionnaire canonique pour les loaders en aval."""
        return {
...
def from_row(row: Dict[str, Any]) -> ProductInput:
    """Construit un ProductInput à partir d'un dictionnaire brut."""
    return ProductInput(
