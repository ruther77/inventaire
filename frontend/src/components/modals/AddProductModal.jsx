...
import { useCreateProduct } from '@/hooks/useCatalogMutations.js';
...
export default function AddProductModal({ open, onClose, onSuccess }) {
  ...
  }, [form, validate, createProduct, onSuccess, onClose]);
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-500">
            Alerte si le stock descend en dessous du seuil min ou dépasse le stock max
          </p>
        </div>
